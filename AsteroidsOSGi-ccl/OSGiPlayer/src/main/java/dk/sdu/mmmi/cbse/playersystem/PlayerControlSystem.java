...
public class PlayerControlSystem implements IEntityProcessingService {
    ...
    private IWeapon weaponService = null;
        ...
        for (Entity player : world.getEntities(Player.class)) {
            ...
            if (shoot) {
                if (weaponService != null) {
                    weaponService.spawnBullet(player, gameData, world);
                }
            }
    ...
    public void addIWeaponService(IWeapon weapon) {
        this.weaponService = weapon;
    }
    
    public void removeIWeaponService(IWeapon weapon) {
        if (this.weaponService.equals(weapon)) {
