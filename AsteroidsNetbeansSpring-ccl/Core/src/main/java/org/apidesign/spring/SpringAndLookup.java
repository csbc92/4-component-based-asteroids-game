...
public class SpringAndLookup {
     ...
     * 
     * @param lookup lookup with some content
     * @param id ID to assign to the created context
     * @return context filled with content of the lookup
     */
    public static ApplicationContext create(Lookup lookup, String  id) {
        ClassLoader l = Lookup.getDefault().lookup(ClassLoader.class);
        if (l == null) {
            l = SpringAndLookup.class.getClassLoader();
        }
        return LookupBasedApplicationContext.create(id, lookup, l);
    }
}
